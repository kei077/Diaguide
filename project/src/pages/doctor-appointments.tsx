      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="bg-rose-50 border-l-4 border-rose-500 p-5 rounded-md shadow-md">
          <div className="flex">
            ...
            <div className="ml-4">
              <p className="text-base text-rose-700 font-medium">Seuls les médecins peuvent accéder à cette page.</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredAppointments.map((appointment) => (
                  <tr key={appointment.id} className="hover:bg-green-50 transition-colors duration-150">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-500">{appointment.patient_age || "—"}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-500">{appointment.patient_type_diabete || "Non spécifié"}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-700 font-medium">{formatDate(appointment.date)}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-500 max-w-xs line-clamp-2">{appointment.reason || "—"}</div>
                    </td>
